...
%\includegraphics[width=\linewidth]{images/gridbox.jpg} 
%\label{fig:gridbox}
%\end{wrapfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{images/virtual_screening.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics{images/bioaccumulation.jpg}
...
%% nell'appendice mettere Virtual Screening, NAM ? no..