...
% riportare il nome delle proteine a titolo d'esempio
% riportare l'utilizzo di Google Colab/PurpleJeans
% riportare python notebook ? 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=6cm]{images/2h8v_acrinathrin.jpg}
        \caption[]%
        {{\small Acrinathrin}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/2h8v_dimethomorph.jpg}
        \caption[]%
        {{\small Dimethomorph}}    
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/2h8v_glyphosate.jpg}
        \caption[]%
        {{\small Glyphosate}}    
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=6cm]{images/4e81_acrinathrin.jpg}
        \caption[]%
        {{\small Acrinathrin}}    
        \label{fig:2h8v_acrinathrin}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/4e81_dimethomorph.jpg}
        \caption[]%
        {{\small Dimethomorph}}    
        \label{fig:2h8v_dimethomorph}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/4e81_glyphosate.jpg}
        \caption[]%
        {{\small Glyphosate}}    
        \label{fig:2h8v_glyphosate}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=6cm]{images/6lqk_b_acrinathrin.jpg}
        \caption[]%
        {{\small Acrinathrin}}    
        \label{fig:2h8v_acrinathrin}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/6lqk_b_dimethomorph.jpg}
        \caption[]%
        {{\small Dimethomorph}}    
        \label{fig:2h8v_dimethomorph}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        \includegraphics[width=\textwidth, height=6cm]{images/6lqk_b_glyphosate.jpg}
        \caption[]%
        {{\small Glyphosate}}    
        \label{fig:2h8v_glyphosate}
    \end{subfigure}
...
% confronto sui risultati in termini di rmsd
% riportare tabella con dati 
...
% affinità inconsistente rispetto ai legami prodotti



% confronto in termini di legami formati
...
% bassa RMSD non si traduce in affinità migliore
% affinità migliore non implica la formazione di legami più stabili
% oppure bassa RMSD permette la formazione di legami più stabili ?



% grafico per ciascuna proteina sia heatmap che istogramma
% sicuramente 1fcu per la differenza abissale tra residui e legami prodotti così come 5xz3_a
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=6cm]{images/heatmaps/heatmap_gnina_1fcu.jpg}
        \caption[]%
    ...
    \begin{subfigure}[b]{\textwidth}  
        \centering 
        \includegraphics[width=0.9\textwidth, height=6cm]{images/heatmaps/heatmap_vina_1fcu.jpg}
        \caption[]%
...
% interazioni 1fcu\ 5xz3_A
% divisione in subsection

% gnina coinvolge più residui, heatmaps più ampie e sparse (meno contatti), legami più distribuiti
% vina produce heatmaps più fitte per alcuni residui, più selettività tra i residui, interazioni riassumibili considerando solo alcuni dei residui totali
...
% confronto sulle caratteristiche
...
% prima di consegnare tesi, revisionare codice python e effettuare refactoring della api
